                    ...
                    <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                        ...
                        <td class="pl-24">
                            <div class="flex items-center">
                                <p class="text-sm leading-none text-gray-600 ml-2">Город</p>
                            </div>
                        </td>
                        <td class="pl-5">
                            <div class="flex items-center">
                                <p class="text-sm leading-none text-gray-600 ml-2">Телефон</p>
                            </div>
                        </td>
                        <td class="pl-3">
                            <p class="text-sm leading-none text-gray-600 ml-2">Telegram login </p>
                        </td>
                    </tr>
                    </thead>
