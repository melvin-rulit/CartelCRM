            ...
            <div class="mt-7 overflow-x-auto">
                ...
                <table class="w-full whitespace-nowrap">
                    ...
                    <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                        <td class="">
                            <div class="flex items-center pl-5">
                                <p class="text-base leading-none text-gray-700 mr-2">ФИО контрагента</p>
                            </div>
                        </td>
                        <td class="">
                            <div class="flex items-center pl-5">
                    ...
                    <tr v-for="client of clients" :key=client.id tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                        <td class="">
                            <div class="flex items-center pl-5">
                                <p class="text-sm font-medium leading-none text-gray-700 mr-2">{{ client.fullName }}</p>
                            </div>
                        </td>
                        <td class="">
                            <div class="flex items-center pl-5">
                                <p class="text-sm leading-none text-gray-600 ml-2">{{ client.phoneNumber }}</p>
                            </div>
                        </td>
                        <td class="">
                            <div class="flex items-center pl-5">
