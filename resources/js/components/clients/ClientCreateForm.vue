    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        <div class="px-6 py-6 lg:px-8">
            ...
            <form @submit="store">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <TextInput title="Серия паспорта" name="passportSeries" v-model:value="client.passportSeries"
                               type="text"/>
                </div>
                <div class="relative z-0 w-full mb-6 group">
                    <TextInput title="Номер паспорта" name="passportNumber" v-model:value="client.passportNumber"
                               type="text"/>
                </div>
                <div class="relative z-0 w-full mb-6 group">
            ...
            <div v-show="this.client.id">
                ...
                <div class="flex flex-row flex-wrap mt-5">
                    <div v-for="file in files" :key="file.id"
                        ...
                        <img class="rounded-t-lg max-w-[256px] max-h-[256px] m-auto" :src="file.path"
                             :alt="file.filename" :title="file.filename"/>
                        <div class="p-3 overflow-hidden">
                            <div class="mb-1 font-normal text-gray-700 dark:text-gray-400">Размер: {{ file.filesize }}
                                Мб
                            </div>
        ...
        store: async function (event) {
            ...
            ClientService.store(this.client)
                .then(response => {
                    ...
                    this.$router.push({name: 'activesList'})
                })
                .catch(error => {
