<template>
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        <div class="px-6 py-6 lg:px-8">
            <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Редактирование источника
                финансирования</h3>
            <Alert :errors="errors"/>
            ...
            <form @submit="update">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <NumberInput title="Процент" v-model:value="source.percent" min="0" step="0.01"/>
                </div>
                <div class="relative z-0 w-full mb-6 group">
...
export default {
    ...
    mounted() {
        SourceService.getById(this.id)
            .then(response => this.source = response.data.source)
        ...
        update: async function (event) {
            ...
            SourceService.update(this.source)
                .then(response => {
                    ...
                    this.message = 'Источник финансирования обновлен'
                })
                .catch(error => {
