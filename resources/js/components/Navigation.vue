                ...
                <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        <ul class="pb-2 space-y-2">
                            ...
                            <li>
                                <router-link to="/providers_orders" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            ...
                            <li>
                                <router-link to="/counterparties" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                    ...
                                    <span class="ml-3" sidebar-toggle-item="">Контрагенты</span>
                                </router-link>
                            </li>
                            <li>
                            ...
                            <div v-show="this.user.roleId === 1">
                                <li>
                                    <router-link to="/sources" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                        ...
                                        <span class="ml-3" sidebar-toggle-item="">Источники финансирования</span>
                                    </router-link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <router-link to="/stats-payments" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                        ...
                                        <span class="ml-3" sidebar-toggle-item="">Отчет по фин. операциям</span>
                                    </router-link>
                                </li>
                                <li>
                                    <router-link to="/stats-actives" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
