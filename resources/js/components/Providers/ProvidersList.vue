<template>
    ...
    <div class="sm:px-6 w-full">
        <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
            <h3 class="text-4xl font-extrabold dark:text-white">Список поставщиков</h3>
            <div class="mt-7 overflow-x-auto">
                ...
                <table class="w-full whitespace-nowrap">
                    ...
                    <tr v-for="provider of providers" :key="provider.id" tabindex="0"
                        ...
                        <td class="">
                            <div class="flex items-center">
                                <p class="text-sm leading-none text-gray-600 ml-2">{{ provider.phone }}</p>
                            </div>
                        </td>
                        <td class="">
                            <div class="flex items-center">
                        ...
                        <td class="pl-4">
                            <div class="flex">
                                ...
                                <button @click.stop="deleteUser(provider.id)" class="text-red-700 focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none py-2 px-2 rounded hover:bg-red-200 focus:outline-none">
                                    <svg fill="none" height="25" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
export default {
    ...
    methods: {
        goToProvider(id) {
            this.$router.push({ path: '/providers/detail/' + id });
        },

        update: function () {
            this.loading = true;
            ProvideService.getProvides(this.query)
