                ...
                <form>
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input v-model="provider.full_name" id="full_name" type="text" readonly
                                   @mousedown.prevent
                                   @copy.prevent
                                   @paste.prevent
                                   @selectstart.prevent/>
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="provider.city" id="city" type="text" readonly
                                   @mousedown.prevent
                                   @copy.prevent
                                   @paste.prevent
                                   @selectstart.prevent/>
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="provider.phone" id="phone" type="text" readonly
                                   @mousedown.prevent
                                   @copy.prevent
                                   @paste.prevent
                                   @selectstart.prevent/>
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="provider.telegram" id="telegram" type="text" readonly
                                   @mousedown.prevent
                                   @copy.prevent
                                   @paste.prevent
                                   @selectstart.prevent/>
