            ...
            <Success :message="message"/>
                ...
                <div class="grid md:grid-cols-3 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <TextOnly title="Фамилия" v-model:value="provider.lastName" type="text" :isEditable="false"/>
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                        <TextOnly title="Имя" v-model:value="provider.firstName" type="text" :isEditable="false"/>
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                        <TextOnly title="Отчество" v-model:value="provider.middleName" type="text" :isEditable="false"/>
                    </div>

                    <div class="relative z-0 w-full mb-6 group">
                        <TextOnly title="Город" v-model:value="provider.city" type="text" :isEditable="false"/>
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                        <TextOnly title="Телефон" v-model:value="provider.phone" type="text" :isEditable="false"/>
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                        <TextOnly title="Телеграм" v-model:value="provider.telegram_login" type="text" :isEditable="false"/>
                    </div>
                </div>


            <h3 class="mb-4 mt-4 text-xl font-medium text-gray-900 dark:text-white">Заказы поставщика
            </h3>
