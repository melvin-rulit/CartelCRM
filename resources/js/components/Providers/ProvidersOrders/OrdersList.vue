                    ...
                    <tr tabindex="0" class="focus:outline-none h-14 border border-gray-100 rounded divide-x">
                        <td class="text-center">
                            <div class="flex items-center justify-center">
                                <p class="text-base font-semibold leading-none text-gray-700 mr-2">Номер заказа
                                </p>
                            </div>
                        </td>
                        <td class="text-center">
                            <div class="flex items-center justify-center">
                                <p class="text-base font-semibold leading-none text-gray-600 ml-2">Дата заказа
                                </p>
                            </div>
                        </td>
                        <td class="text-center">
                        ...
                        <td class="text-center">
                            <div class="flex items-center justify-center">
                                <p class="text-base font-semibold leading-none text-gray-600 ml-2">ФИО поставщика</p>
                            </div>
                        </td>
                        <td class="text-center">
                            <div class="flex items-center justify-center">
                        ...
                        <td class="text-center">
                            <div class="flex items-center justify-center">
                                <p class="text-base font-semibold leading-none text-gray-600 ml-2">Сумма заказа</p>
                            </div>
                        </td>
<!--                        <td class="">-->
...
<!--                        </td>-->
                    ...
                    <tr v-for="order of orders" :key="order.id" tabindex="0"
                        ...
                        <td class="text-center">
                            <div class="flex items-center justify-center">
                                <p class="text-sm leading-none text-gray-600 ml-2">{{ order.provider.name }}</p>
                            </div>
                        </td>
                        <td class="text-center">
                            <div class="flex items-center justify-center">
