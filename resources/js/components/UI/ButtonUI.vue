<template>
  ...
  <button :class="[colorClass]" :style="{ width: width, padding: padding, fontSize: fontSize, fontWeight: fontWeight }" @click="handleClick">
...
export default {
  props: {
    ...
    color: {
      ...
      validator: function (value) {
        return ['blue', 'white', 'grey'].includes(value);
      }
    },
    // Ширина по умолчанию
    width: {
  ...
  computed: {
    colorClass() {
      return this.color === "blue" ? "blue-button" : (this.color === "white" ? "white-button" : "grey-button");
    },
  },
