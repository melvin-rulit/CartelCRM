<template>
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        <div class="px-6 py-6 lg:px-8">
            <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Добавление контрагента</h3>
            <Alert :errors="errors" />
...
export default {
    name: "UserCreateForm",
    components: {DateInput, Checkbox, Select, Alert, TextInput, Success, Textarea},
    data: function () {
        return {
            loading: false,
            userRoles: [],
